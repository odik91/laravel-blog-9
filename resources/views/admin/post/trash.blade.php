              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="{{ asset('post-image/' . $post['image']) }}" alt="" class="img-thumbnail" width="150"></td>
                    <td>{{ ucfirst($post->getUser['name']) }}</td>
                    <td>
                      <a href="{{ route('post.restore', $post['id']) }}" class="btn btn-warning mb-1" title="restore"><i class="fas fa-trash-restore"></i></a></a>
