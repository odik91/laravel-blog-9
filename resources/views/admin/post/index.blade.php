        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{ route('post.create') }}" class="btn btn-info btn-sm float-right"><i
                ...
                <tbody>
                  @foreach ($posts as $key => $post)
                    <tr>
                      ...
                      <td><img src="{{ asset('post-image/' . $post['image']) }}" alt="" class="img-thumbnail"
                          width="150"></td>
                      <td>{{ ucfirst($post->getUser['name']) }}</td>
                      <td>
                        <a href="{{ route('post.show', $post['id']) }}" class="btn btn-info mb-1" title="view"><i
                            class="far fa-eye"></i></a>
                        <a href="{{ route('post.edit', $post['id']) }}" class="btn btn-warning mb-1" title="edit"><i
